export default function PrivacyPage() {
  return (
    <main className="site-wrap legal-wrap">
      ...
      <p>
        We use data to provide support, maintain compliance documentation workflows, improve service
        quality, and respond to legal or policy-related inquiries.
      </p>

      <h2>3. Data Sharing</h2>
      <p>
        We do not sell personal data. Data may be shared with trusted service providers under
        confidentiality obligations, or when required by law.
      </p>

      <h2>4. Data Retention</h2>
      <p>
        Support and compliance records are retained only as long as necessary for operational, legal,
        and audit purposes, then deleted or anonymized according to retention policy.
      </p>
